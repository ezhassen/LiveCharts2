...
public partial class App : Application
{
    public App()
    {
        //MainWindow = new WPFSample.MainWindow();
    }
    protected override void OnStartup(StartupEventArgs e)
    {
        base.OnStartup(e);
        LiveChartsCore.SkiaSharpView.WPF.GLInitialize.InitializeRenderGPU();
        MainWindow.Title = "GPU Rendering using GL";
