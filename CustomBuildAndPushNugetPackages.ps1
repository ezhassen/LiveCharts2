# projectNames and dll names without extinsons then parent dir after DirPrefix after src\
$projectNamesAndDllNames = @{
    "LiveChartsCore"     = @("LiveChartsCore", "")
    "LiveChartsCore.SkiaSharpView"   = @("LiveChartsCore.SkiaSharpView", "skiasharp")
    "LiveChartsCore.SkiaSharpView.WinForms"   = @("LiveChartsCore.SkiaSharpView.WinForms", "skiasharp")	 
    "LiveChartsCore.SkiaSharpView"   = @("LiveChartsCore.SkiaSharpView", "skiasharp")	 
    "LiveChartsCore.SkiaSharpView"   = @("LiveChartsCore.SkiaSharpView", "skiasharp")	 
    "LiveChartsCore.SkiaSharpView"   = @("LiveChartsCore.SkiaSharpView", "skiasharp")	 
    "LiveChartsCore.SkiaSharpView"   = @("LiveChartsCore.SkiaSharpView", "skiasharp")	 
...
$MainTargetFramWork = "net9.0-windows" # To get dll version
$DirPrefix = "src\"
...
if (-not [string]::IsNullOrEmpty($yourString)) {
    $projectFolder = Join-Path -Path $projectFolder -ChildPath $DirPrefix
}
    # Combine script root with the project folder and file name
    $projectFolder = Join-Path -Path $projectFolder -ChildPath $projectName
